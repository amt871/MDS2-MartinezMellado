...
public class MartinezMelladoMDSPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MartinezMelladoMDS";
	...
	private MartinezMelladoMDSPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(Comentario.class);
		aMetadataSources.addAnnotatedClass(Hashtag.class);
		aMetadataSources.addAnnotatedClass(Publicacion.class);
		aMetadataSources.addAnnotatedClass(Notificacion.class);
		aMetadataSources.addAnnotatedClass(Administrador.class);
		aMetadataSources.addAnnotatedClass(Denuncia_Archivada.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MartinezMelladoMDSPersistentManager();
		}
