...
public class AdministradorDAO {
	...
	public static boolean save(Administrador administrador) throws PersistentException {
		try {
			MartinezMelladoMDSPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Administrador administrador) throws PersistentException {
		try {
			MartinezMelladoMDSPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(Administrador administrador)throws PersistentException {
		try {
			Denuncia_Archivada[] lHa_atendidos = administrador.ha_atendido.toArray();
			for(int i = 0; i < lHa_atendidos.length; i++) {
				lHa_atendidos[i].setAtendida(null);
			}
			Usuario_Registrado[] lBloqueas = administrador.bloquea.toArray();
			for(int i = 0; i < lBloqueas.length; i++) {
				lBloqueas[i].setEs_bloqueado(null);
			}
	...
	public static boolean refresh(Administrador administrador) throws PersistentException {
		try {
			MartinezMelladoMDSPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Administrador administrador) throws PersistentException {
		try {
			MartinezMelladoMDSPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
