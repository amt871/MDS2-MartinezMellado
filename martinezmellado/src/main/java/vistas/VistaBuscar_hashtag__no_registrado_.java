...
/**
 * A Designer generated component for the vista-buscar_hashtag__no_registrado_ template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-buscar_hashtag__no_registrado_")
@JsModule("./src/vista-buscar_hashtag__no_registrado_.ts")
public class VistaBuscar_hashtag__no_registrado_ extends LitTemplate {
	...
	/**
     * Creates a new VistaBuscar_hashtag__no_registrado_.
     */
    public VistaBuscar_hashtag__no_registrado_() {
