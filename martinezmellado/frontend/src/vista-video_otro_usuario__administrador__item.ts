...
<vaadin-horizontal-layout class="content" style="width: 100%; height: 100%;">
 <vaadin-vertical-layout style="width: 60%; height: 100%; align-self: center; align-items: center; justify-content: center;">
  <img style="align-self: flex-start; width: 90%; height: 90%;" src="../../resources/icons/video.svg">
 </vaadin-vertical-layout>
 <vaadin-vertical-layout style="width: 40%; height: 100%; align-self: center; align-items: center; justify-content: center;">
  <img style="width: 30%;" src="../../resources/icons/user.svg">
  <label>Usuario</label>
  <vaadin-horizontal-layout theme="spacing-s" style="width: 100%; align-items: center; justify-content: center;">
   <vaadin-horizontal-layout theme="spacing" style="align-self: center; align-items: center; justify-content: center; width: 50%;">
    <label style="width: 50%; align-self: center;">Ubicacion</label>
   </vaadin-horizontal-layout>
   <vaadin-horizontal-layout theme="spacing" style="justify-content: center; align-items: center; align-self: center; width: 50%;">
    <label style="width: 50%; align-self: center;">Fecha de publicacion</label>
   </vaadin-horizontal-layout>
  </vaadin-horizontal-layout>
  <label style="margin-top: var(--lumo-space-l); margin-bottom: var(--lumo-space-l);">Descripcion</label>
