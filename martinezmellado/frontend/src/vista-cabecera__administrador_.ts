...
<vaadin-vertical-layout style="width: 100%; height: 100%; align-items: center; justify-content: center;">
 <vaadin-horizontal-layout class="content" style="width: 100%; align-items: center; justify-content: space-between;">
  <vaadin-button style="margin-left: 1%;" id="bInicio2">
    Inicio 
  </vaadin-button>
  <vaadin-button id="bBusqueda2">
    Busqueda 
  </vaadin-button>
  <vaadin-horizontal-layout theme="spacing-s" style="margin-right: 1%; flex-grow: 0; flex-shrink: 1;">
   <vaadin-button style="flex-grow: 0; flex-shrink: 1; align-self: center;" id="bAdministrar2">
     Administrar 
   </vaadin-button>
   <vaadin-button theme="icon" aria-label="Add new" id="bPerfil2">
    <iron-icon icon="lumo:user"></iron-icon>
   </vaadin-button>
   <vaadin-button theme="icon" aria-label="Add new" id="bSalir2">
